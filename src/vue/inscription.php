...
<body class="w3-content" style="max-width:100%">
    ...
    <div class="w3-main" style="margin-left:250px">
        ...
        <!-- Content -->
            ...
            <form class="w3-container" action="index.php?route=userController&action=createUser" method="POST">

                <label class="w3-text-blue" ><b>Nom : </b></label>
                <input class="w3-input w3-border w3-round" type="text" name="nom" id="nom">
                
                <label class="w3-text-blue"><b>Prenom : </b></label>
                <input class="w3-input w3-border w3-round" type="text" name="prenom" id="prenom">
